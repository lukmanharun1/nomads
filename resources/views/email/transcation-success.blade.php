                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                                border="0"
                                                                style="color:#071c4d;font-family:Asistant, Helvertica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                                                <tr>
                                                        ...
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right;">
                                                                        {{ $data->travel_package->departure_date }}</td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center" bgcolor="#ff9e53"
                                                                        ...
                                                                        <a href="{{ url('checkout/' . $data->id) }} "
                                                                            style="display:inline-block;background:#ff9e53;color:#ffffff;font-family:Asistant, helvertica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                                                            Check Detail </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                        ...
                                        <td align="left"
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        style="font-size: 18px; padding-left: 10px; color: #071c4d; font-family: Assistant, Helveltica, Arial, sans-serif">
                                                        support@nomads.id <br> 021-2020-2022 </td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Assistant, Helvertica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888893;">
