                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img alt="" height="auto" src="{{url('frontend/image/logo.png')}} " style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <tbody>
                          <tr>
                            <td style="width:550px;">
                              <img alt="" height="auto" src="{{ url
                              ($data->travel_package->galleries[0]->image) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                            </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <div style="font-family:Asistant, Helvertica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">Hi, {{$data->user->name}} <br><br> Tiket Digital kamu udah berhasil dicetak. <br> booking ID <strong>#{{$data->id}} </strong></div>
                            </td>
                          </tr>
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071c4d;font-family:Asistant, Helvertica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                <tr>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                <tr>
                                  <td align="center" bgcolor="#ff9e53" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#ff9e53;" valign="middle">
                                    <a href="{{ url('checkout/' . $data->id) }} " style="display:inline-block;background:#ff9e53;color:#ffffff;font-family:Asistant, helvertica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"> Check Detail </a>
                                  </td>
                                </tr>
                              </table>
                            </td>
          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Asistant, Helvertica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">Butuh Bantuan?</div>
                    </td>
                  </tr>
                </table>
              </div>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                        <tr>
                          <td style="width: 50px;">
                            <img src="{{ url('frontend/image/ic_support.png') }}" width="50px">
                          </td>
                          <td style="font-size: 18px; padding-left: 10px; color: #071c4d; font-family: Assistant, Helveltica, Arial, sans-serif"> support@nomads.id <br> 021-2020-2022 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Helvertica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888893;">2020 Nomads Copyright All Rights Reserved.</div>
                    </td>
                  </tr>
                </table>
              </div>
