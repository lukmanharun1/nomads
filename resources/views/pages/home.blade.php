...
@section('content')
  ...
  <header class="text-center">
    ...
    <a href="#" class="btn btn-get-started px-4 mt-3">Get started</a>
  </header>
        ...
        <div class="section-popular-travel row justify-content-center">
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card-travel text-center d-flex flex-column"
              style="background-image: url('frontend/image/travel-1.jpg');">
              <div class="travel-country">INDONESIA</div>
              <div class="travel-location">DRETAN,BALI</div>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card-travel text-center d-flex flex-column"
              style="background-image: url('frontend/image/travel-2.jpg');">
              <div class="travel-country">INDONESIA</div>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card-travel text-center d-flex flex-column"
              style="background-image: url('frontend/image/travel-3.jpg');">
              <div class="travel-country">INDONESIA</div>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card-travel text-center d-flex flex-column"
              style="background-image: url('frontend/image/travel-4.jpg');">
      ...
      <div class="container">
        <div class="section-popular-travel row justify-content-center">
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                <img src="frontend/image/avatar-1.png" alt="testimonial" class="mb-4 rounded-circle">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                <img src="frontend/image/avatar-2.png" alt="testimonial" class="mb-4 rounded-circle">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                <img src="frontend/image/avatar-3.png" alt="testimonial" class="mb-4 rounded-circle">
