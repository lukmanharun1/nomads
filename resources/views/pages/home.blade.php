...
@section('content')
    ...
    <header class="text-center">
        ...
        <a href="#popular" class="btn btn-get-started px-4 mt-3">Get started</a>
    </header>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 text-center">
                        <img src="assets/image/partner.png" alt="logo partner" class="img-partner">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="section-popular-travel row justify-content-center">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="assets/image/avatar-1.png" alt="testimonial" class="mb-4 rounded-circle">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="assets/image/avatar-2.png" alt="testimonial" class="mb-4 rounded-circle">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="assets/image/avatar-3.png" alt="testimonial" class="mb-4 rounded-circle">
